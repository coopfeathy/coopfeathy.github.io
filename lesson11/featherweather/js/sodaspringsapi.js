//Preston
const weatherURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&appid=3e08552e49dac3ae3cad2390c4518b7c";
fetch(weatherURL)
...
//gets forecast
const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=3e08552e49dac3ae3cad2390c4518b7c";
fetch(forecastURL)
  .then((response) => response.json())
  .then((jsObject) => {
...
fetch(eventURL)
    ...
    .then(function (jsonObject) {
        ...
        const townInfo = towns.filter(town => town.name == "Soda Springs");
